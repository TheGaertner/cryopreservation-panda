...
//    const std::array<double, 7>joint_collision = {20.0};
//    const std::array<double, 7>joint_contact = {10.0};

//    const std::array<double, 6>cartesian_collision  = {20.0};
//    const std::array<double, 6>cartesian_contact  = {10.0};
...
void setDefaultBehavior(franka::Robot *robot) {
    ...
    robot->setCollisionBehavior(
                ...
                cartesian_contact, cartesian_collision);
    robot->setJointImpedance({{3000, 3000, 3000, 2500, 2500, 2000, 2000}});
    robot->setCartesianImpedance({{3000, 3000, 300, 300, 300, 300}});
}

void setDefaultBehavior2(franka::Robot *robot) {
    std::array<double, 7>joint_collision;
    joint_collision.fill(100);
    std::array<double, 7>joint_contact;
    joint_contact.fill(100);

    std::array<double, 6>cartesian_collision;
    cartesian_collision.fill(100);
    std::array<double, 6>cartesian_contact;
    cartesian_contact.fill(100);
